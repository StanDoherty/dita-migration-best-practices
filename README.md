...
Making mistakes and course corrections during a DITA migration are inevitable. Expect them. The following best practices for workgroup DITA migrations are designed to reduce the amount of time or effort that is required for you to recover, to get back on the right tack. Let's take an example. If your workgroup does not have an experienced DITA architect on board (and many do not), you are going to bump into lots or little surprises and gotchas. No avoiding it. If you have made technology and design choices that maximize the ability of DITA experts and user groups in the community to help you out when you veer off course, your mean recovery time will be short. If you adopt highly proprietary technologies or highly customized designs, you have severely limited the ability of people outside your workgroup to help you get back on course. 
